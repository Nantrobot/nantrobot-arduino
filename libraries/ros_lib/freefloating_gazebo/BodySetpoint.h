#ifndef _ROS_freefloating_gazebo_BodySetpoint_h
#define _ROS_freefloating_gazebo_BodySetpoint_h
...
namespace freefloating_gazebo
{
  ...
  class BodySetpoint : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "freefloating_gazebo/BodySetpoint"; };
